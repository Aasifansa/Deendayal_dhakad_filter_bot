...
BOT_TOKEN = environ.get('BOT_TOKEN', "8009312694:AAFrLwLA5TBKgzG-dUjqEo6_FSCjG9s-Cyc")
...
NEW_IMAGE_FETCH = bool(environ.get('DEENDAYAL_IMAGE_FETCH', False))  #  On ( True ) / Off ( False )
