...
NEW_IMAGE_FETCH = bool(environ.get('DEENDAYAL_IMAGE_FETCH', True))  #  On ( True ) / Off ( False )
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/you_wanthub')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/xyzmovieshu') #Support group link ( make sure bot is admin )
